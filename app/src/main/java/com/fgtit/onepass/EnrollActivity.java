...
public class EnrollActivity extends Activity {
    ...
    private EditText editText1, editText2, editText6, editText7,editText8, editText9, editText10/*, editText11, editText12,editText13,editText14*/;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_save: {
                if (CheckInputData(1)) {
                    person.id = (editText1.getText().toString().trim());
                    person.name = (editText2.getText().toString().trim());
                    if (isenrol1) {
    ...
    private void FPInit() {
        ...
        vFingerprint.setOnGetImageListener(new OnGetImageListener() {
            ...
            public void onGetImageFail() {
                Log.d("EnrollActivity", "11111111111111111111");
                if (!bIsCancel) {
                    if (bcheck) {
                        bcheck = false;
        ...
        vFingerprint.setOnUpImageListener(new OnUpImageListener() {
            ...
            public void onUpImageFail() {
                Log.d("EnrollActivity", "22222222222222222222");
            }
        });
        ...
        vFingerprint.setOnGenCharListener(new OnGenCharListener() {
            ...
            public void onGenCharFail() {
                ...
                Log.d("EnrollActivity", "33333333333333333333");
            }
        });
        ...
        vFingerprint.setOnRegModelListener(new OnRegModelListener() {
            ...
            public void onRegModelFail() {
                Log.d("EnrollActivity", "4444444444444444444444");
        ...
        vFingerprint.setOnUpCharListener(new OnUpCharListener() {
            ...
            public void onUpCharFail() {
                Log.d("EnrollActivity", "555555555555555555");
                tvFpStatus.setText(getString(R.string.txt_fpenrolfail));
            }
        });
