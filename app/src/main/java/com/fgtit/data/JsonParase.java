		...
		JSONArray jsonarray1 = new JSONArray();
		 try {
			 for(int i=0;i<list.size();i++){
				 ...
				 jsonObj1.put("phone1", list.get(i).phone);
				 jsonObj1.put("phone2", list.get(i).phone2);
				 ...
				 jsonObj1.put("device", list.get(i).device);
				 jsonObj1.put("company", list.get(i).company);
        ...
        try {
           /* JSONObject jsonObject=new JSONObject(json); 
            ...
            for(int i=0;i<jsonArray1.length();i++){
				...
				hi.phone2=jsonObject1.getString("phone2");
				...
				hi.device=jsonObject1.getString("device");
				hi.company=jsonObject1.getString("company");
